...
import app.db.rowmapper.scrum.SutbCategoryRM;

public class SuprCategoryFindByReportId extends StoredProcedure {

	public SuprCategoryFindByReportId(DataSource dataSource) {

		super(dataSource, "");
		this.setFunction(false);
		this.setSql("SUPR_CATEGORY_FIND_BY_REPORT_ID");
		...
		this.declareParameter(new SqlReturnResultSet("pRESULTSET_ROWS", new SutbCategoryRM()));

		// this.setUpdatableResults(true);
		this.compile();
	}

	public Map<String, Object> getCategoryListByReportId(String sutbReportDetailId) {
